...
export * from './communication/icon_money'
export * from './communication/icon_close'
export * from './communication/icon_search'
...
export * from './social/icon_google'
export * from './social/icon_facebook'

// Icons sidebar
export * from './sidebar/icon_home'
export * from './sidebar/icon_stats'
export * from './sidebar/icon_logout'
export * from './sidebar/icon_clients'
export * from './sidebar/icon_calendar'
export * from './sidebar/icon_settings'